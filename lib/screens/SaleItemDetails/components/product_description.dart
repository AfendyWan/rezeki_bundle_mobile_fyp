          ...
          if (projectSnap.connectionState == ConnectionState.none) {
            ...
            return Column(
              ...
              children: [
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            isWishList ? Color(0xFFFFE6E6) : Color(0xFFF5F6F9),
                      ...
                      child: SvgPicture.asset(
                        ...
                        color:
                            isWishList ? Color(0xFFFF4848) : Color(0xFFDBDEE4),
                ...
                widget.saleItem!.itemPromotionStatus == 0 ||
                        widget.saleItem!.itemPromotionStatus == null
                    ? Padding(
                        padding: EdgeInsets.only(
                          top: getProportionateScreenHeight(20),
                          left: getProportionateScreenWidth(20),
                    ...
                    : Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              "Only @ RM" +
                                  widget.saleItem!.itemPromotionPrice!,
                              style: TextStyle(
                                fontSize: 24,
                                color: Colors.red,
                              ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              widget.saleItem!.itemPromotionStartDate! +
                                  " - " +
                                  widget.saleItem!.itemPromotionEndDate!,
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.red,
                              ),
                ...
                Padding(
                  ...
                  child: Text(
                    "Currently only " +
                        widget.saleItem!.itemStock!.toString() +
                        " stocks available",
