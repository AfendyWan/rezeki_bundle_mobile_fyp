...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: getProportionateScreenWidth(widget.leftWidth), right:getProportionateScreenWidth(widget.rightWidth), ),
      child: SizedBox(
                ...
                child: Container(
                  ...
                  child: Hero(
                    tag: widget.saleItemCategory.id!,
                     child: Image.network("http://192.168.0.157:8000"+widget.saleItemCategory.url!)
                  ),
                ),
              ),
